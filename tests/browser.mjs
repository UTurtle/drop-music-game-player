...
try {
  ...
  await page.getByRole('heading', { name: 'Turn your own music into a rhythm game.' }).waitFor();
  ...
  await page.getByRole('heading', { name: '당신이 가지고 있는 음악을 바로 리듬게임으로 만들어보세요.' }).waitFor();
